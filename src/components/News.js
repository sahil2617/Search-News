  ...
  render() {
    ...
    return(
        ...
        <div className='container my-3'>
            <h3 className='text-center'>News - Crypto, Politics, Sports etc.</h3> <br />
            ...
            <button type="button" disabled={ (this.state.page + 1) > Math.ceil(this.state.totalResults/this.pageSize)} onClick={this.goToNextPage} className="btn btn-danger">Next &rarr;</button>
            </div>
        </div>
        </>
    );
